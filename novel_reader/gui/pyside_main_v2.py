"""
PySide6 GUI 界面 - 有声书阅读器 (新架构版本)

主入口文件，启动 PySide6 GUI 应用程序
使用新的 PlaybackController 架构
"""
import sys
...
def run_gui_v2(create_test: bool = False):
    """
    运行 PySide6 GUI 应用程序 (新架构版本)
    ...
    # 设置应用程序信息
    app.setApplicationName("Novel Reader V2")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Novel Reader V2 - 本地有声书管理器 (新架构)"
    )
    parser.add_argument(
        "--test",
        action="store_true",
    ...
    run_gui_v2(create_test=args.test)
